...
import com.fossgalaxy.games.asteroids.utilities.StatSummary;
...
public class GAIndividual
{
     ...
     */
    public double evaluate(SimpleBattle gameState)
    {
        ...
        for(int i = 0; i < m_genome.length; ++i)
        {
            ...
            {
               thisGameCopy.update(ActionMap.actions[thisAction]);
                ...
                Vector2d myPos = thisGameCopy.getShip().getLocation();
        ...
        m_fitness = thisGameCopy.getPoints();
