...
import com.fossgalaxy.games.asteroids.utilities.Util;
...
public class SingleTreeNode
{
    ...
    public SingleTreeNode expand(SimpleBattle state) {
        ...
        //Roll the state
            state.update(ActionMap.ActionMap[bestAction]);
    ...
    public SingleTreeNode uct(SimpleBattle state) {
        ...
        //Roll the state:
        state.update(ActionMap.ActionMap[selected.childIdx]);
    ...
    public double rollOut(SimpleBattle state)
    {
        ...
        while (!finishRollout(state,thisDepth)) {
            ...
            state.update(ActionMap.ActionMap[action]);
            thisDepth++;
        }
    ...
    public double value(SimpleBattle a_gameState) {
        ...
        boolean stillAlive = !a_gameState.getShip().isDead();

        double rawScore = a_gameState.getHeuristic();

/*        if(gameOver && !stillAlive)
