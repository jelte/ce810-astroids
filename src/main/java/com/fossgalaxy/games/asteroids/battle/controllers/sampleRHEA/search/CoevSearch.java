package com.fossgalaxy.games.asteroids.battle.controllers.sampleRHEA.search;

import com.fossgalaxy.games.asteroids.battle.Constants;
...
import com.fossgalaxy.games.asteroids.battle.controllers.sampleRHEA.strategy.ICoevPairing;
import com.fossgalaxy.games.asteroids.battle.controllers.sampleRHEA.strategy.ICrossover;
import com.fossgalaxy.games.asteroids.battle.controllers.sampleRHEA.strategy.IMutation;
import com.fossgalaxy.games.asteroids.battle.controllers.sampleRHEA.strategy.ISelection;
...
public class CoevSearch extends Search {
    ...
    public void init(SimpleBattle gameState, int _playerID)
    {
        ...
        for(int i = 0; i < NUM_INDIVIDUALS; ++i) {
            ...
            m_individuals[i].randomize(m_rnd, ActionMap.actions.length);

            m_individualsOpp[i] = new GAIndividual(Search.NUM_ACTIONS_INDIVIDUAL, -1, null);
            m_individualsOpp[i].randomize(m_rnd, ActionMap.actions.length);
        }
