package com.fossgalaxy.games.asteroids.math;
...
public class Vector2d {
     ...
     *
     * @param first The starting point to add to
     * @param x     The value to be added to the X axis
     * @param y     The value to be added to the Y axis
     * @return The unique Vector2d that represents the result of the operation
     */
    ...
    public static double dot(Vector2d v1, Vector2d v2) {
        return Vector2d.scalarProduct(v1, v2);
    }
     ...
     *
     * @param x The value to be added to X axis
     * @param y The value to be added to Y axis
     */
